...
export const artists: Artist[] = [
  {
    ...
    reviews: [
      { id: "rev-nil-1", author: "مریم کاظمی", text: L("تکرار الگو کاملاً بی‌درز بود و روی دیوار چهار متری هیچ درزی دیده نشد.", "The repeat was perfectly seamless — no visible seam on a four-metre wall."), rating: 5, date: "2026-06-14" },
      { id: "rev-nil-2", author: "Studio Karim", text: L("فایل‌ها با DPI درست تحویل شد و چاپخانه بدون اصلاح چاپ کرد.", "Files arrived at the right DPI and the printer ran them without corrections."), rating: 5, date: "2026-04-02" },
      { id: "rev-nil-3", author: "امیر رستمی", text: L("پالت رنگی دقیقاً با نور شمالی خانه هماهنگ شد؛ فقط تحویل کمی طول کشید.", "The palette matched our north-facing light exactly; delivery just took a little longer."), rating: 4, date: "2026-02-19" },
    ],
  },
  {
    ...
    status: "approved", // seed content is curated, so it starts live
    reviews: [
      { id: "rev-arm-1", author: "هتل پارسیان", text: L("برای ۳۲ اتاق اجرا شد؛ مقیاس الگو برای لابی هم بدون هزینه‌ی اضافه بازطراحی شد.", "Used across 32 rooms; the lobby scale was redrawn at no extra cost."), rating: 5, date: "2026-07-01" },
      { id: "rev-arm-2", author: "نگار شریفی", text: L("هندسه‌ی پرده دقیق و بدون خطا بود.", "The curtain geometry was precise and fault-free."), rating: 5, date: "2026-05-11" },
      { id: "rev-arm-3", author: "دفتر معماری سایه", text: L("همکاری حرفه‌ای؛ فقط کاش تنوع رنگی بیشتر بود.", "Professional collaboration; we just wished for a wider colour range."), rating: 4, date: "2026-01-27" },
    ],
  },
  {
    ...
    status: "approved", // seed content is curated, so it starts live
    reviews: [
      { id: "rev-sar-1", author: "سمیرا نوری", text: L("برای اتاق کودکم گرفتم؛ بافت پارچه نرم است و بعد از سه شست‌وشو رنگ نداد.", "For my kid's room — the fabric is soft and hasn't bled after three washes."), rating: 5, date: "2026-08-03" },
      { id: "rev-sar-2", author: "مهدکدهٔ نیلوفر", text: L("کاغذدیواری داستان‌گو برای بچه‌ها عالی جواب داد.", "The storytelling wallpaper was a hit with the children."), rating: 5, date: "2026-06-25" },
      { id: "rev-sar-3", author: "Raha Deco", text: L("ارسال سریع و بسته‌بندی تمیز؛ یک رول اضافه هم برای اشتباه برش داشتیم.", "Fast shipping, clean packing, and we had a spare roll for cutting mistakes."), rating: 4, date: "2026-03-08" },
    ],
  },
  {
    ...
    status: "approved", // seed content is curated, so it starts live
    reviews: [
      { id: "rev-hos-1", author: "خانهٔ تاریخی قاجار", text: L("اسلیمی را برای سقف بازخوانی کرد؛ همان نسبت‌های سنتی با اجرای امروزی.", "He reinterpreted the eslimi for a ceiling — traditional proportions, contemporary execution."), rating: 5, date: "2026-05-30" },
      { id: "rev-hos-2", author: "فریدون آذری", text: L("چهل سال تجربه در کار دیده می‌شود؛ مشاوره‌ی رنگ فوق‌العاده بود.", "Forty years of experience shows; the colour consultation was superb."), rating: 5, date: "2026-02-14" },
    ],
  },
];
